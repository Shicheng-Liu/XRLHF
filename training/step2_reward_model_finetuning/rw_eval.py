...
def run_pair_comparison():
    ...
    for prompt, good_ans, bad_ans in zip(prompt_list, good_ans_list,
        ...
        # print("Model dtype:", next(rm_model.parameters()).dtype)
        ...
        # print("raw_good_ans score: ", outputs["chosen_mean_scores"])
        # print("raw_bad_ans score: ", outputs["rejected_mean_scores"])
