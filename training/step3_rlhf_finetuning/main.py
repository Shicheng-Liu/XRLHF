...
def parse_args():
    ...
    parser.add_argument(
        ...
        required=True)
    parser.add_argument(
        "--baseline_actor_model_name_or_path",
        type=str,
        help=
        "Path to base model identifier from huggingface.co/models. This model is the base model of SFT model",
        required=True)
    parser.add_argument(
...
def main():
    ...
    for epoch in range(args.num_train_epochs):
        ...
        for step, (batch_prompt, batch_unsupervised) in enumerate(
            ...
            # print('batch_prompt in mainpy',batch_prompt)
            ...
            if exp_dataset is not None:
                ...
                for ppo_ep in range(args.ppo_epochs):
                    for i, (exp_data, unsup_data) in enumerate(
                        ...
                        # print("exp_data in mainpy",exp_data)
