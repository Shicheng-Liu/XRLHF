...
DEV=0,3
PORT=1236
BASELINE_ACTOR_MODEL_PATH="EleutherAI/pythia-2.8b"
ACTOR_MODEL_PATH=~/workspace/siyuan/rlhf/training/step1_supervised_finetuning/output/pythia-2.8b/full-hh-rlhf
CRITIC_MODEL_PATH=~/workspace/siyuan/rlhf/training/step2_reward_model_finetuning/output/pythia-2.8b/full-hh-rlhf
